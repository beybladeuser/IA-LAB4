...
class TicTacToeBoardTest {
	...
	void testGenerateSuccessors0()
	{
		...
		expectedSuccessors.add(new TicTacToeBoard("X-X\nOOO\nXXO", 2));
	...
	void testGenerateSuccessors1()
	{
		...
		TicTacToeBoard board = new TicTacToeBoard(init, 2);
		List<ILayout> expectedSuccessors = new ArrayList<ILayout>();
		expectedSuccessors.add(new TicTacToeBoard("XXX\nOO-\nXXO", 1));
	...
	void testGenerateSuccessors2()
	{
		...
		List<ILayout> expectedSuccessors = new ArrayList<ILayout>();
		expectedSuccessors.add(new TicTacToeBoard("X--\n---\n---", 1));
		expectedSuccessors.add(new TicTacToeBoard("-X-\n---\n---", 1));
		expectedSuccessors.add(new TicTacToeBoard("--X\n---\n---", 1));
		expectedSuccessors.add(new TicTacToeBoard("---\nX--\n---", 1));
		expectedSuccessors.add(new TicTacToeBoard("---\n-X-\n---", 1));
		expectedSuccessors.add(new TicTacToeBoard("---\n--X\n---", 1));
		expectedSuccessors.add(new TicTacToeBoard("---\n---\nX--", 1));
		expectedSuccessors.add(new TicTacToeBoard("---\n---\n-X-", 1));
	...
	void testGenerateSuccessors3()
	{
		...
		List<ILayout> expectedSuccessors = new ArrayList<ILayout>();
		expectedSuccessors.add(new TicTacToeBoard("O--\n---\n---", 2));
		expectedSuccessors.add(new TicTacToeBoard("-O-\n---\n---", 2));
		expectedSuccessors.add(new TicTacToeBoard("--O\n---\n---", 2));
		expectedSuccessors.add(new TicTacToeBoard("---\nO--\n---", 2));
		expectedSuccessors.add(new TicTacToeBoard("---\n-O-\n---", 2));
	...
	void testGenerateSuccessors4()
	{
		...
		TicTacToeBoard board = new TicTacToeBoard(init, 1);
		List<ILayout> expectedSuccessors = new ArrayList<ILayout>();
		expectedSuccessors.add(new TicTacToeBoard("ooo\n---\noxo", 2));
		expectedSuccessors.add(new TicTacToeBoard("o-o\no--\noxo", 2));
		expectedSuccessors.add(new TicTacToeBoard("o-o\n-o-\noxo", 2));
		expectedSuccessors.add(new TicTacToeBoard("o-o\n--o\noxo", 2));
		List<ILayout> actualSuccessors = board.generateSuccessors();
	...
	void testGenerateSuccessors5()
	{
		...
		TicTacToeBoard board = new TicTacToeBoard(init, 1);
		List<ILayout> expectedSuccessors = new ArrayList<ILayout>();
		expectedSuccessors.add(new TicTacToeBoard("o-x\nO--\noxo", 2));
		expectedSuccessors.add(new TicTacToeBoard("o-x\n-o-\noxo", 2));
		List<ILayout> actualSuccessors = board.generateSuccessors();
	...
	void testGenerateSuccessors6()
	{
		...
		TicTacToeBoard board = new TicTacToeBoard(init, 2);
		List<ILayout> expectedSuccessors = new ArrayList<ILayout>();
		expectedSuccessors.add(new TicTacToeBoard("oxo\n-x-\noxo", 1));
		List<ILayout> actualSuccessors = board.generateSuccessors();
