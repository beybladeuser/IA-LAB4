...
public class TicTacToeBoard implements ILayout, Cloneable {
	...
	public ILayout simulateSuccessor() {
		...
		//check and prevent at obvious loss
	 ...
	 */
	private List<Integer> checkPossibleWinsForPlayer(int player) throws IllegalArgumentException {
